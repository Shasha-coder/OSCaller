    ...
    <div className={cn(
      ...
      {isHome && (
        ...
        >
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 pb-28 pt-12 lg:pr-[80px]">
          ...
          {/* Services ticker + Join link */}
          <div className="absolute bottom-0 left-0 right-0 z-10 pb-[max(env(safe-area-inset-bottom),10px)] lg:pb-[env(safe-area-inset-bottom)]">
            <div className="mb-1.5 flex items-center justify-center px-4 lg:pr-[80px]">
              <a href="/join" className="flex items-center justify-center gap-1.5 rounded-full bg-white/10 backdrop-blur-sm px-5 py-2 text-[11px] font-medium text-white/70 transition-all hover:bg-white/20 hover:text-white">
